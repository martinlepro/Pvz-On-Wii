 ...
 * explicitly -- either a real path or an explicit NULL -- so the array can
 * never silently fall short of PLANT_TYPE_COUNT again. Plants still marked
 * NULL simply don't have art yet; drop a PNG in and fill in the path. */
static const char* s_seedIconPaths[PLANT_TYPE_COUNT] = {
    ...
    NULL,                              /* PLANT_DOOM_SHROOM */
    NULL,                              /* PLANT_LILY_PAD */
    NULL,                              /* PLANT_SQUASH */
    NULL,                              /* PLANT_THREEPEATER */
    NULL,                              /* PLANT_TANGLE_KELP */
    "assets/seeds/jalapeno.png",       /* PLANT_JALAPENO */
    NULL,                              /* PLANT_SPIKEWEED */
    NULL,                              /* PLANT_TORCHWOOD */
    NULL,                              /* PLANT_TALLNUT */
    NULL,                              /* PLANT_SEA_SHROOM */
    NULL,                              /* PLANT_PLANTERN */
    NULL,                              /* PLANT_CACTUS */
    NULL,                              /* PLANT_BLOVER */
    NULL,                              /* PLANT_SPLIT_PEA */
    NULL,                              /* PLANT_STARFRUIT */
    NULL,                              /* PLANT_PUMPKIN */
    NULL,                              /* PLANT_MAGNET_SHROOM */
    NULL,                              /* PLANT_CABBAGE_PULT */
    NULL,                              /* PLANT_FLOWER_POT */
    NULL,                              /* PLANT_KERNEL_PULT */
    NULL,                              /* PLANT_COFFEE_BEAN */
    NULL,                              /* PLANT_GARLIC */
    NULL,                              /* PLANT_UMBRELLA_LEAF */
    NULL,                              /* PLANT_MARIGOLD */
    NULL,                              /* PLANT_MELON_PULT */
    "assets/seeds/gatling_pea.png",    /* PLANT_GATLING_PEA */
    NULL,                              /* PLANT_TWIN_SUNFLOWER */
    NULL,                              /* PLANT_GLOOM_SHROOM */
    NULL,                              /* PLANT_CATTAIL */
    NULL,                              /* PLANT_WINTER_MELON */
    NULL,                              /* PLANT_GOLD_MAGNET */
    NULL,                              /* PLANT_SPIKEROCK */
    NULL,                              /* PLANT_COB_CANNON */
    NULL,                              /* PLANT_IMITATER */
};
...
bool Render_Init(void)
{
    ...
    s_font = GRRLIB_LoadTTFFromFile("assets/font/pvz_font.ttf");
    if (!s_font)
...
/** Fill color per projectile kind. This game draws every shot as a simple
 *  circle rather than a modeled sprite, so getting these colors right is
 *  what actually reads as "a pea", "a frozen pea", "a cabbage", etc. The
 *  classic Peashooter/Repeater/Gatling Pea/Threepeater/Split Pea shot is
 *  PROJ_PEA -- the plain green pea ball from the original game. */
